...
import static com.example.pupomonth.R.id;
import static com.example.pupomonth.R.layout;
...
public class MainActivityTemp extends AppCompatActivity {
    ...
    private void runCameraResult(Bitmap bitmap){
        Intent cameraResultIntent = new Intent(MainActivityTemp.this, CameraResultTempActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.all_activity_main_temp);

        navi3 = findViewById(id.navi3);
        navi4 = findViewById(id.navi4);
        ...
        navi4.setOnClickListener(v->{
            Intent nintent = new Intent(MainActivityTemp.this, BoardTempActivity.class);
